const welcome = () => {
  ...
  center;text-transform:uppercase;font-size: 10px;" > Lorem ipsum, dolor sit amet consectetur adipisicing elit. 
  Necessitatibus, aliquid ratione? Sunt, maiores eaque explicabo ab et itaque. Culpa repellendus qui voluptate 
  porro incidunt! Officia suscipit ducimus accusamus quos velit? </p></td></tr></table> </body></html>`;
};
...
const purchase = (data) => {
  const renderItems  = () => {
    ...
    data.products.forEach(item => {
      ...
      border: 1px solid #dddddd; text-align: left; padding: 8px;">${item.quantity}</td><td style=" border: 1px solid #dddddd; 
  ...
  text-align: center; text-transform: uppercase;font-size:10px" > Lorem ipsum dolor sit amet, consectetur 
  adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
  quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. </p></td></tr></table> 
  </body></html>`
};
