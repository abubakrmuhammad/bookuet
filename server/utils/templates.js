const welcome = () => {
  ...
  width:600px;"> <tr> <td style="margin:0 auto;background-color:#718093;box-sizing:border-box;color:#fff;
  letter-spacing:0.5px;padding:15px 25px;text-align:center;text-transform:uppercase;font-family:Helvetica,
  sans-serif;" > <h1>Welcome to Bookuet</h1> </td></tr><tr> <td style="margin:0 auto;background-color:#718093;
  height:400px;font-family:Helvetica,sans-serif;"> <a href="/"><img class="pic" style="height:100%;" 
  src="https://picsum.photos/600/400?image=1073"/></a> </td></tr><tr> <td style="margin:0 auto;background-color:#718093;font-family:Helvetica,
...
const purchase = data => {
  const renderItems = () => {
    ...
    data.products.forEach(item => {
      template += `<tr><td style=" border: 1px solid #dcdde1; text-align: left; padding: 8px;">${item.title}</td>
      <td style=" border: 1px solid #dcdde1; text-align: left; padding: 8px;">$ ${item.price}</td><td style=" 
      border: 1px solid #dcdde1; text-align: left; padding: 8px;">${
        item.quantity
      }</td><td style=" border: 1px solid #dcdde1; 
  ...
  <tr> <td style="background-color: #718093; margin: 0 auto;"> <h1 style="box-sizing: border-box; color: white;
  ...
  <tr style=" border: 1px solid #dcdde1; background: #ccc; text-align: left; padding: 8px;"><th style="border: 1px
  solid #dcdde1; text-align: left; padding: 8px;">Book Title</th><th style=" border: 1px solid #dcdde1; 
  text-align: left; padding: 8px;">Price</th> <th style=" border: 1px solid #dcdde1; text-align: left; 
  padding: 8px;">Quantity</th> <th style=" border: 1px solid #dcdde1; text-align: left; padding: 8px;">Total Price
  </th></tr>${renderItems()}</table><p><strong>Order ID:</strong> ${data.products[0].porder}</p></div></td></tr><tr> 
  <td style="background-color: #718093; margin: 0 auto;"> <p style="box-sizing: border-box; color: white;
